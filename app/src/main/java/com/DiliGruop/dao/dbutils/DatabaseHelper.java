...
import com.DiliGruop.dao.table.DBAddress;
...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper
{
			...
			ConnectionSource connectionSource)
	{
		try
		{
			...
			TableUtils.createTable(connectionSource, DBAddress.class);
			...
			ConnectionSource connectionSource, int oldVersion, int newVersion)
	{
		try
		{
			...
			TableUtils.dropTable(connectionSource, DBOrder.class, true);
